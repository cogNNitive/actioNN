...
| Skill | When to use |
|---|---|
| `/nn-dev-opencode-model-router` | No estás seguro de que el modelo actual sea el correcto para la tarea |
...
|---|---|
| `nn-innfo` | Trabajás con archivos iNNfo (`*_NN.md`, `*_FORMAT.md`) |
| `nn-design-presets` | Trabajás con archivos web o de diseño |
| `agent-web-bootstrap` | El usuario escribe "usar eNNvironment", "bootstrap" o pasa una URL de manifest |
| `nn-onboarding-wizard` | El usuario dice "crear un modelo", "nuevo modelo", "empezar un modelo" |
| `nn-router` | El usuario escribe "innfo" en su prompt (dispara todo el ecosistema iNNfo) |
